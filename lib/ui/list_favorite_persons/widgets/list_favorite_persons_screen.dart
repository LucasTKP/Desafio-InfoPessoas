...
import 'package:infopessoas/ui/core/widgets/generic_error_screen.dart';
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text('A lista de favoritos esta vazia.', style: context.textTheme.bodyMedium?.copyWith(color: Colors.grey[600])),
                        ],
                      ),
                    );
                  }
